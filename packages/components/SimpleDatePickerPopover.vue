 ...
 * @LastEditors: Quarter
 * @LastEditTime: 2022-03-11 07:10:45
 * @Description: 日期选择器弹窗
-->
<template>
  <div class="simple-date-picker-popover">
    ...
    <div v-else>
      <div class="picker-header">
        <div class="left-operation">
          <simple-button type="normal" @click="previousYear">
            <i class="simple-icon-arrow-left"></i>
          </simple-button>
        </div>
        <div class="date-info">
        ...
        <div class="right-operation">
          <simple-button type="normal" @click="nextYear">
            <i class="simple-icon-arrow-right"></i>
          </simple-button>
        </div>
      </div>
...
<script lang="ts">
import Vue from "vue";
import { SimpleDayConfig } from "../types";

export default Vue.extend({
  name: "SimpleDatePickerPopover",
  props: {
    width: String, // 宽度
    height: String, // 高度
    value: Number, // 值
  ...
  data() {
    return {
      ...
      monthDay: new Array<SimpleDayConfig>(), // 每月的号数
      datePickerVisible: true, // 显示日期选择
      yearPickerVisible: false, // 显示年份选择
      yearToChoose: 0, // 当前年份
      yearArray: new Array<number>(), // 可选的年份号
  ...
  methods: {
    ...
    init(): void {
      ...
      this.date = new Date(date.formate("yyyy-MM-dd") + " 00:00:00");
